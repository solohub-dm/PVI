  ...
  <header class="wrapper-header">
      ...
      <div class="header-control-panel">
          ...
          <div id="wrapper-message-menu">
            <div class="message-menu-item"> 
              <div class="message-avatar-panel">
                <img src="./img/avatar_rev_white.png" alt="avatar" class="icon-message-avatar" />
              </div>
        ...
        <div id="profile-panel">
          <img src="./img/avatar_dir_white.png" alt="profile avatar" id="icon-profile-avatar" />
          <p class="profile-username" id="profile-username">Dmytro Solohub</p>
          <div id="wrapper-profile-menu">
            <p class="profile-menu-item"><a href="#">Profile</a></p>
            <p class="profile-menu-item"><a href="#">Log out</a></p>
          </div>
        </div>
    </div>
  </header> 
